...
import com.salesmanager.core.business.exception.ConversionRuntimeException;
...
public class ReadableProductPopulator extends
    ...
    @Autowired
    @Qualifier("localImageFilePathUtils")
    ...
    public ReadableProduct populate(Product source,
        ...
        try {
            ...
            if (description != null) {
                com.salesmanager.shop.model.catalog.product.ProductDescription tragetDescription = new com
                        .salesmanager.shop.model.catalog.product.ProductDescription();
            ...
            if (source.getManufacturer() != null) {
                ...
                com.salesmanager.shop.model.catalog.manufacturer.ManufacturerDescription d = new com.salesmanager
                        .shop.model.catalog.manufacturer.ManufacturerDescription();
            ...
            if (image != null) {
                ...
                imagePath.append(contextPath).append(imageUtils.buildProductImageUtils(store, source.getSku(), image
                        .getProductImage()));
                ...
                if (images != null && images.size() > 0) {
                    ...
                    for (ProductImage img : images) {
                        ...
                        imgPath.append(contextPath).append(imageUtils.buildProductImageUtils(store, source.getSku(),
                                img.getProductImage()));
